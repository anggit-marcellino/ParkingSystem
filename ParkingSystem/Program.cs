...
namespace ParkingSystem
{
    internal class Program
    {
        ...
        public static void Menu()
        {
            ...
            Console.WriteLine("5. Type Of Vehicle");
            Console.WriteLine("6. Registration Numbers For Vehicles With Odd/Event");
            Console.WriteLine("7. Registration Numbers For Vehicles With Colour");
            Console.WriteLine("8. Slot Numbers For Vehicles With Colour");
            Console.WriteLine("9. Slot Number For Registration Number");
            ...
            switch (key)
            {
                ...
                case "5":
                    ...
                    break;
                case "6":
                    RegistrationNumbersForVehiclesWithOddEvent();
                    break;
                case "7":
                    RegistrationNumbersForVehiclesWithColour();
                    break;
                case "8":
                    SlotNumbersForVehiclesWithColour();
                    break;
                case "9":
        ...
        public static void SlotNumberForRegistrationNumber()
        {
            Console.Clear();
        ...
        public static void SlotNumbersForVehiclesWithColour()
        {
            Console.Clear();
        ...
        public static void RegistrationNumbersForVehiclesWithColour()
        {
            Console.Clear();
            Console.Write("Enter Colour: ");
            string input = Console.ReadLine();
        ...
        public static void RegistrationNumbersForVehiclesWithOddEvent()
        {
            Console.Clear();
